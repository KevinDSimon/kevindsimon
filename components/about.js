...
export default () => {
  ...
  return (
    <div id="About" className="Section">
      ...
      <h1>Hello</h1>
      <p>I am Kevin Simon – a Senior UI designer. I care deeply about creating intuitive and beautiful products that help people accomplish their goals quickly and stress-free. I like to be involved in all stages of a project. From concept, through research and wireframes, high-fidelity designs, and even front-end development.</p>
